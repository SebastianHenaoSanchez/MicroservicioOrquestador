...
public class EliminarApiController implements EliminarApi {
    ...
    public ResponseEntity<JsonApiBodyResponseSuccessNegocio> eliminarNegociosIdnegocioDelete(@ApiParam(value = "id de negocio a eliminar",required=true) @PathVariable("idnegocio") String idnegocio) {
    ...
    public ResponseEntity<JsonApiBodyResponseSuccessOferta> eliminarOfertasIdofertaDelete(@ApiParam(value = "id de oferta a eliminar",required=true) @PathVariable("idoferta") String idoferta) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
    ...
    public ResponseEntity<JsonApiBodyResponseSuccessPersona> eliminarPersonasDelete(@ApiParam(value = "body" ,required=true )  @Valid @RequestBody JsonApiBodyRequestPersonaDelete body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
